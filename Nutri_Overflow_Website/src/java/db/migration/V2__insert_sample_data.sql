...
INSERT INTO Articles (article_id, title, summary, content, image_url, author_username, author_name, status, is_published, created_at) VALUES 
  (1, N'Cáº©m nang sá»­ dá»¥ng Whey Protein Ä‘Ăºng cĂ¡ch vĂ  an toĂ n', 
   N'Whey Protein lĂ  thá»±c pháº©m bá»• sung phá»• biáº¿n giĂºp phĂ¡t triá»ƒn cÆ¡ báº¯p, tuy nhiĂªn viá»‡c sá»­ dá»¥ng sai cĂ¡ch cĂ³ thá»ƒ giáº£m hiá»‡u quáº£ hoáº·c gĂ¢y tĂ¡c dá»¥ng phá»¥.', 
   N'<h4>1. Whey Protein lĂ  gĂ¬?</h4>
<p>Whey Protein lĂ  nguá»“n Ä‘áº¡m cháº¥t lÆ°á»£ng cao Ä‘Æ°á»£c chiáº¿t xuáº¥t tá»« sá»¯a bĂ² trong quĂ¡ trĂ¬nh sáº£n xuáº¥t phĂ´ mai. NĂ³ chá»©a Ä‘áº§y Ä‘á»§ 9 loáº¡i axit amin thiáº¿t yáº¿u (EAAs) mĂ  cÆ¡ thá»ƒ khĂ´ng tá»± tá»•ng há»£p Ä‘Æ°á»£c, vá»›i tá»‘c Ä‘á»™ háº¥p thá»¥ siĂªu nhanh, giĂºp há»— trá»£ Ä‘áº¯c lá»±c cho viá»‡c phá»¥c há»“i vĂ  phĂ¡t triá»ƒn cÆ¡ báº¯p.</p>
<h4>2. PhĂ¢n loáº¡i cĂ¡c loáº¡i Whey Protein phá»• biáº¿n</h4>
<p>TrĂªn thá»‹ trÆ°á»ng hiá»‡n cĂ³ 3 loáº¡i Whey Protein chĂ­nh:</p>
<ul>
    <li><strong>Whey Protein Concentrate (WPC):</strong> Cuá»™c lá»c Ä‘áº§u tiĂªn, giá»¯ láº¡i nhiá»u cháº¥t dinh dÆ°á»¡ng tá»± nhiĂªn cá»§a sá»¯a nhÆ°ng chá»©a hĂ m lÆ°á»£ng lactose vĂ  cháº¥t bĂ©o cao hÆ¡n. PhĂ¹ há»£p cho ngÆ°á»i má»›i báº¯t Ä‘áº§u hoáº·c muá»‘n tiáº¿t kiá»‡m chi phĂ­.</li>
    <li><strong>Whey Protein Isolate (WPI):</strong> ÄĂ£ tráº£i qua quĂ¡ trĂ¬nh lá»c bá» háº§u háº¿t lactose, fat vĂ  carbohydrate, Ä‘áº¡t Ä‘á»™ tinh khiáº¿t trĂªn 90% protein. Ráº¥t tá»‘t cho ngÆ°á»i siáº¿t cÆ¡ hoáº·c nháº¡y cáº£m vá»›i Ä‘Æ°á»ng sá»¯a lactose.</li>
    <li><strong>Whey Protein Hydrolyzed (WPH):</strong> Whey thá»§y phĂ¢n cao cáº¥p nháº¥t, phĂ¢n tĂ¡ch phĂ¢n tá»­ protein thĂ nh cĂ¡c máº¡ch peptide ngáº¯n giĂºp háº¥p thá»¥ cá»±c nhanh vĂ o táº¿ bĂ o cÆ¡ mĂ  khĂ´ng cáº§n tá»‘n nhiá»u thá»i gian tiĂªu hĂ³a á»Ÿ dáº¡ dĂ y.</li>
</ul>
<h4>3. HÆ°á»›ng dáº«n sá»­ dá»¥ng Ä‘Ăºng liá»u lÆ°á»£ng vĂ  thá»i Ä‘iá»ƒm váº§n thiáº¿t</h4>
<p>Má»—i ngĂ y ngÆ°á»i trÆ°á»Ÿng thĂ nh táº­p luyá»‡n nĂªn dĂ¹ng tá»« 1-2 muá»—ng Ä‘á»ƒ bá»• sung protein hiá»‡u quáº£. Hai thá»i Ä‘iá»ƒm vĂ ng Ä‘á»ƒ uá»‘ng Whey lĂ :</p>
<ul>
    <li><strong>Ngay sau khi táº­p:</strong> ÄĂ¢y lĂ  lĂºc cÆ¡ báº¯p cáº§n protein nháº¥t Ä‘á»ƒ sá»­a chá»¯a vĂ  tĂ¡i táº¡o cĂ¡c sá»£i cÆ¡ bá»‹ tá»•n thÆ°Æ¡ng sau buá»•i táº­p náº·ng.</li>
    <li><strong>Buá»•i sĂ¡ng khi vá»«a ngá»§ dáº­y:</strong> CÆ¡ thá»ƒ Ä‘Ă£ tráº£i qua 7-8 tiáº¿ng thiáº¿u há»¥t dinh dÆ°á»¡ng khi ngá»§, má»™t ly Whey háº¥p thá»¥ nhanh sáº½ giĂºp ngÄƒn cháº·n quĂ¡ trĂ¬nh dá»‹ hĂ³a cÆ¡ báº¯p.</li>
</ul>
<h4>4. LÆ°u Ă½ quan trá»ng Ä‘á»ƒ uá»‘ng Whey an toĂ n</h4>
<p>KhĂ´ng nĂªn láº¡m dá»¥ng Whey Protein thay tháº¿ hoĂ n toĂ n cho bá»¯a Äƒn chĂ­nh. HĂ£y duy trĂ¬ cháº¿ Ä‘á»™ Äƒn uá»‘ng Ä‘áº§y Ä‘á»§ tá»« thá»‹t, cĂ¡, trá»©ng vĂ  rau xanh. Náº¿u báº¡n bá»‹ dá»‹ á»©ng náº·ng vá»›i sá»¯a bĂ², hĂ£y cĂ¢n nháº¯c sá»­ dá»¥ng cĂ¡c loáº¡i protein thá»±c váº­t (Plant Protein).</p>', 
   'image/articles/whey_guide.jpg', 'admin', N'Quáº£n trá»‹ viĂªn', 'APPROVED', 1, GETDATE()),
  (2, N'Cháº¿ Ä‘á»™ Äƒn tÄƒng cÆ¡ giáº£m má»¡ (Recomp) cho ngÆ°á»i má»›i báº¯t Ä‘áº§u', 
   N'Body Recomposition lĂ  quĂ¡ trĂ¬nh xĂ¢y dá»±ng cÆ¡ báº¯p Ä‘á»“ng thá»i giáº£m má»¡ thá»«a. ÄĂ¢y lĂ  má»¥c tiĂªu hÆ°á»›ng tá»›i cá»§a ráº¥t nhiá»u Gymer.', 
   N'<h4>1. NguyĂªn lĂ½ hoáº¡t Ä‘á»™ng cá»§a Body Recomposition</h4>
<p>Body Recomposition (tĂ¡i cáº¥u trĂºc cÆ¡ thá»ƒ) lĂ  quĂ¡ trĂ¬nh giáº£m má»¡ thá»«a Ä‘á»“ng thá»i xĂ¢y dá»±ng cÆ¡ náº¡c cĂ¹ng má»™t lĂºc. KhĂ¡c vá»›i phÆ°Æ¡ng phĂ¡p xáº£ cÆ¡ (bulking) hoáº·c siáº¿t cÆ¡ (cutting) truyá»n thá»‘ng, Recomposition táº­p trung vĂ o viá»‡c cáº£i thiá»‡n tá»· lá»‡ cÆ¡/má»¡ mĂ  khĂ´ng lĂ m biáº¿n Ä‘á»™ng quĂ¡ lá»›n vá» cĂ¢n náº·ng.</p>
<h4>2. Thiáº¿t láº­p cháº¿ Ä‘á»™ dinh dÆ°á»¡ng tá»‘i Æ°u</h4>
<p>Äá»ƒ Ä‘áº¡t Ä‘Æ°á»£c má»¥c tiĂªu tÄƒng cÆ¡ giáº£m má»¡ Ä‘á»“ng thá»i, báº¡n cáº§n tuĂ¢n thá»§ cháº¿ Ä‘á»™ dinh dÆ°á»¡ng nghiĂªm ngáº·t:</p>
<ul>
    <li><strong>ThĂ¢m há»¥t calo nháº¹:</strong> HĂ£y duy trĂ¬ má»©c calo náº¡p vĂ o tháº¥p hÆ¡n calo tiĂªu thá»¥ khoáº£ng 10-15% (khoáº£ng 200-300 kcal). ThĂ¢m há»¥t quĂ¡ sĂ¢u sáº½ lĂ m máº¥t cÆ¡ báº¯p.</li>
    <li><strong>Náº¡p lÆ°á»£ng protein dá»“i dĂ o:</strong> Protein lĂ  chĂ¬a khĂ³a duy nháº¥t Ä‘á»ƒ xĂ¢y dá»±ng cÆ¡. Báº¡n nĂªn náº¡p tá»« 1.8g Ä‘áº¿n 2.2g protein trĂªn má»—i kg trá»ng lÆ°á»£ng cÆ¡ thá»ƒ má»—i ngĂ y.</li>
    <li><strong>Carbohydrate vĂ  Fat thĂ´ng minh:</strong> Táº­p trung vĂ o tinh bá»™t háº¥p thu cháº­m (khoai lang, gáº¡o lá»©t, yáº¿n máº¡ch) vĂ  cháº¥t bĂ©o tá»‘t (háº¡t háº¡nh nhĂ¢n, bÆ¡, dáº§u Ă´-liu).</li>
</ul>
<h4>3. Cháº¿ Ä‘á»™ táº­p luyá»‡n khĂ¡ng lá»±c khoa há»c</h4>
<p>Táº­p luyá»‡n lĂ  kĂ­ch thĂ­ch báº¯t buá»™c Ä‘á»ƒ cÆ¡ thá»ƒ giá»¯ láº¡i vĂ  phĂ¡t triá»ƒn cÆ¡ báº¯p trong tráº¡ng thĂ¡i thĂ¢m há»¥t calo. HĂ£y táº­p táº¡ Ă­t nháº¥t 3-4 buá»•i/tuáº§n, táº­p trung vĂ o cĂ¡c bĂ i táº­p Ä‘a khá»›p (Compound) nhÆ° Squat, Deadlift, Bench Press, káº¿t há»£p vá»›i cĂ¡c buá»•i Cardio cÆ°á»ng Ä‘á»™ tháº¥p (LISS) Ä‘á»ƒ tÄƒng cÆ°á»ng Ä‘á»‘t má»¡.</p>', 
   'image/articles/recomp_diet.jpg', 'admin', N'Quáº£n trá»‹ viĂªn', 'APPROVED', 1, GETDATE()),
  (3, N'Eat Clean: Cháº¿ Ä‘á»™ Äƒn lĂ nh máº¡nh cáº£i thiá»‡n vĂ³c dĂ¡ng tá»‘i Æ°u', 
   N'Eat Clean khĂ´ng chá»‰ lĂ  má»™t cháº¿ Ä‘á»™ Äƒn kiĂªng, mĂ  lĂ  lá»‘i sá»‘ng lĂ nh máº¡nh giĂºp báº¡n thanh lá»c cÆ¡ thá»ƒ, giáº£m má»¡ tá»± nhiĂªn vĂ  duy trĂ¬ nÄƒng lÆ°á»£ng tĂ­ch cá»±c.', 
   N'<h4>1. KhĂ¡i niá»‡m Eat Clean lĂ  gĂ¬?</h4>
    <p>Eat Clean lĂ  phÆ°Æ¡ng phĂ¡p Äƒn uá»‘ng Æ°u tiĂªn sá»­ dá»¥ng thá»±c pháº©m tÆ°Æ¡i sá»‘ng, nguyĂªn báº£n, chÆ°a qua cháº¿ biáº¿n quĂ¡ nhiá»u hoáº·c khĂ´ng chá»©a cĂ¡c cháº¥t phá»¥ gia, cháº¥t báº£o quan nhĂ¢n táº¡o. Má»¥c tiĂªu cá»‘t lĂµi cá»§a Eat Clean lĂ  giĂºp cÆ¡ thá»ƒ háº¥p thá»¥ nguá»“n dinh dÆ°á»¡ng tinh khiáº¿t nháº¥t.</p>
    <h4>2. CĂ¡c nguyĂªn táº¯c cÆ¡ báº£n khi Äƒn Eat Clean</h4>
    <p>Äá»ƒ báº¯t Ä‘áº§u Eat Clean hiá»‡u quáº£, báº¡n cáº§n ghi nhá»› cĂ¡c nguyĂªn táº¯c vĂ ng sau:</p>
    <ul>
        <li><strong>Ä‚n thá»±c pháº©m nguyĂªn báº£n:</strong> Chá»n gáº¡o lá»©t thay cho gáº¡o tráº¯ng, chá»n yáº¿n máº¡ch nguyĂªn cĂ¡m, Äƒn trĂ¡i cĂ¢y tÆ°Æ¡i thay vĂ¬ uá»‘ng nÆ°á»›c Ă©p Ä‘Ă³ng chai.</li>
        <li><strong>Háº¡n cháº¿ tá»‘i Ä‘a Ä‘Æ°á»ng tinh luyá»‡n:</strong> TrĂ¡nh xa bĂ¡nh káº¹o ngá»t, nÆ°á»›c ngá»t cĂ³ ga. HĂ£y dĂ¹ng máº­t ong hoáº·c Ä‘Æ°á»ng cá» ngá»t tá»± nhiĂªn Ä‘á»ƒ táº¡o ngá»t nháº¹.</li>
        <li><strong>Tá»± náº¥u Äƒn táº¡i nhĂ :</strong> GiĂºp báº¡n kiá»ƒm soĂ¡t tá»‘t lÆ°á»£ng dáº§u má»¡, muá»‘i vĂ  gia vá»‹ náº¡p vĂ o cÆ¡ thá»ƒ.</li>
        <li><strong>Ä‚n nhiá»u rau xanh vĂ  trĂ¡i cĂ¢y:</strong> Äáº£m báº£o cung cáº¥p Ä‘á»§ lÆ°á»£ng cháº¥t xÆ¡, vitamin vĂ  khoĂ¡ng cháº¥t tá»± nhiĂªn giĂºp há»‡ tiĂªu hĂ³a khá»e máº¡nh.</li>
    </ul>
    <h4>3. Lá»£i Ă­ch vÆ°á»£t trá»™i cho sá»©c khá»e vĂ  vĂ³c dĂ¡ng</h4>
    <p>Ä‚n Eat Clean Ä‘á»u Ä‘áº·n giĂºp báº¡n giáº£m má»¡ thá»«a tá»± nhiĂªn, lĂ n da sĂ¡ng khá»e má»‹n mĂ ng hÆ¡n nhá» Ä‘Æ°á»£c thanh lá»c tá»‘t. Äá»“ng thá»i cáº£i thiá»‡n há»‡ tim máº¡ch, tÄƒng má»©c nÄƒng lÆ°á»£ng vĂ  giáº£m má»‡t má»i trong cĂ¡c hoáº¡t Ä‘á»™ng háº±ng ngĂ y.</p>', 
   'image/articles/eat_clean_guide.jpg', 'admin', N'Quáº£n trá»‹ viĂªn', 'APPROVED', 1, GETDATE());
