...
public class OrderNotification {
    ...
    public String getTypeIcon() {
        ...
        switch (type) {
            ...
            case "ORDER_PROCESSING":return "fa-box-open";
            case "ORDER_DELIVERED": return "fa-check-double";
    ...
    public String getTypeColorClass() {
        ...
        switch (type) {
            ...
            case "ORDER_PROCESSING":return "notif-processing";
            case "ORDER_DELIVERED": return "notif-delivered";
